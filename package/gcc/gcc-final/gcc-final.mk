...
ifeq ($(BR2_TOOLCHAIN_BUILDROOT_GO),y)
HOST_GCC_FINAL_LIBGO_VERSION = 2ad0970e9da95024110cd3244e9e21313af70a5f
HOST_GCC_FINAL_EXTRA_DOWNLOADS += https://github.com/golang/gofrontend/tarball/$(HOST_GCC_FINAL_LIBGO_VERSION)
HOST_GCC_FINAL_POST_EXTRACT_HOOKS += HOST_GCC_LIBGO_EXTRACT
define HOST_GCC_LIBGO_EXTRACT
	zcat $(HOST_GCC_FINAL_DL_DIR)/$(HOST_GCC_FINAL_LIBGO_VERSION) | $(TAR) --strip-components=1 -C $(@D) $(TAR_OPTIONS) -
	rm -r $(@D)/gcc/go/gofrontend
	mv $(@D)/go $(@D)/gcc/go/gofrontend
endef
endif
